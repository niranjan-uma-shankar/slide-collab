    ...
    return (
        <>
            ...
            <div className="flex-1 overflow-auto p-8 flex items-center justify-center bg-gray-50">
                <SlideElements elements={Array.from(currentSlide.elements)} currentSlideIndex={currentSlideIndex} />
            </div>
        </>
    );
}

function SlideElements({elements, currentSlideIndex}: {elements: TextElement[], currentSlideIndex: number}) {
